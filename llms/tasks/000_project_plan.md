# AurumFinance - LLM Issue Execution Conventions
...
- If the issue is too broad, split it into a proposed checklist in the response and implement only the first safe slice.
- If issue scope conflicts with constitution/guidelines, follow the constitution and explain the conflict.
